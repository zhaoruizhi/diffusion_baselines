#!/usr/bin/env python3
"""Build deterministic C64 conditional prompt artifacts."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    from dlb.conditional_prompts import build_prompts, load_protocol
    ...
    for dataset_id in datasets:
        manifest = build_prompts(root, dataset_id, protocol)
